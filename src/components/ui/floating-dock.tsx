  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  href={item.href}
                  key={item.title}
                  className="flex items-center justify-center rounded-full bg-gray-50 dark:bg-neutral-900"
                >
      ...
      <button
        ...
        className="flex items-center justify-center rounded-full bg-gray-50 dark:bg-neutral-800"
      >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden items-end gap-4 rounded-2xl bg-gray-50 px-4 pb-3 dark:bg-neutral-900 md:flex",
        className,
      )}
    >
      {items.map((item) => (
